            ...
            <div className="card justify-between max-h-96 h-full max-[490px]:px-2 p-8 flex flex-col items-center mt-8 relative w-full">
              ...
              <div className="text-start">
                ...
                <p className="text-grotto-100">
                  I’m David Mark from Argentina. I’m looking to trade my
                  computer coding skills in order to learn German and Maths
                </p>
                <br />
              ...
              <div className="text-start w-full pt-6">
                <a
                  href="#"
                  className="btn filled bg-grotto-100 text-white px-4 py-1 rounded-2xl inline-block text-start"
                >
                  View Profile
                </a>
              </div>
